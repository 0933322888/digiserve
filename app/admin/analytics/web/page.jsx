...
export default function WebAnalyticsPage() {
  ...
  const [restaurantId, setRestaurantId] = useState('default') // Default for single-tenant
  ...
  useEffect(() => {
    fetchAnalyticsData()
  }, [dateRange, customStartDate, customEndDate, deviceFilter, campaignFilter, referrerFilter])
