...
/**
 * Client Component for Drinks Menu with Dietary Filtering
 */
export default function DrinksMenuClient({ sections }) {
    ...
    <>
      ...
      {filteredSections.length === 0 ? (
        ...
        filteredSections.map((section, index) => (
          <MenuSection key={section.id} section={section} index={index} showOrdering={showOrdering} />
        ))
      )}
    </>
  )
