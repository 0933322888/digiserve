...
export default function MenuFilters({ onFilterChange }) {
  ...
  return (
    <div className="mb-8 flex flex-wrap gap-3 justify-center items-center">
      <div className="flex items-center gap-2 text-sm font-medium text-[var(--secondary-dark-text)]">
      ...
      <button
        ...
        className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
          dietaryFilters.vegetarian
            ...
            : 'bg-[var(--secondary-dark-bg)] text-[var(--secondary-dark-text)] hover:bg-[var(--primary-dark-bg)]/10'
        }`}
      >
        Vegetarian
      </button>
      ...
      {(dietaryFilters.vegetarian || dietaryFilters['gluten-free']) && (
        <button
          ...
          className="px-4 py-2 rounded-lg text-sm font-medium text-[var(--secondary-dark-text)] hover:text-[var(--primary-dark-text)] underline"
        >
          Clear Filters
        </button>
      )}
